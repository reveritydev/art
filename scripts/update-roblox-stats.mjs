...
const pdResponse = await fetch(`https://games.roblox.com/v1/games/multiget-place-details?placeIds=${ids}`);
if(!pdResponse.ok) throw new Error(`Roblox place API returned ${pdResponse.status}`);
const pd = await pdResponse.json();
